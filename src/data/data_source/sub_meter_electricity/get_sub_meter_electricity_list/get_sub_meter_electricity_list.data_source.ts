...
export default async function GetSubMeterElectricityListDataSource({ authModel, paginationModel }: GetSubMeterElectricityListDataSourceParams): Promise<Failure | SubMeterElectricityEntity[]> {
    try {
