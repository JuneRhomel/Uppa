...
import GetMotherMeterElectricityDataSourceParams from "./interface/get_mother_meter_electicity_data_source.params";
import { plainToInstance } from "class-transformer";

export default async function GetMotherMeterElectricityDataSource({ authModel, paginationModel }: GetMotherMeterElectricityDataSourceParams): Promise<MotherMeterElectricityModel[] | Failure> {
    try {
