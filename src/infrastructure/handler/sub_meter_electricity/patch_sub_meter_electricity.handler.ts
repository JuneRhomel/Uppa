...
import PatchSubMeterElectricityUseCase from "../../../domain/use_case/sub_meter_electricity/patch_sub_meter_electricity/patch_sub_meter_electricity.use_case";
import SubMeterElectricityDto from "../../../application/dto/sub_meter_electricity.dto";

export default async function PatchSubMeterElectricityHandler({ req, res }: ApiGatewayHelperParams): Promise<Response> {
    try {
        ...
        const response = await PatchSubMeterElectricityUseCase({ authModel, subMeterElectricityEntity })
